# Function to calculate total effects of treatments on major bleeding using 99% truncated IPWs


func_results_safe_trunc <- function(data,outcome,outcome1, cut_times) {

# Function to create stabilized time-varying IP censoring weights using baseline confounders for stroke/SE outcomes 


ipc_wt_eff <- function(data_long){
...
write.table(weights_36, paste0("analysis/output/tables/weights_eff_36_ipw"), sep="\t", quote=FALSE, row.names=FALSE)
